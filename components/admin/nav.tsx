...
export function AdminSidebar({
  ...
  return (
    <aside
      className={`flex flex-col h-full bg-sidebar-bg text-sidebar-foreground ${className}`}
    >
      <div className="p-6">
...
export function MobileNav({ user }: { user: any }) {
  ...
  return (
    <div className="md:hidden">
      ...
      {/* Drawer */}
      <div
        className={`fixed inset-y-0 left-0 w-72 z-50 transform transition-transform duration-300 ease-in-out ${isOpen ? "translate-x-0" : "-translate-x-full"}`}
      >
